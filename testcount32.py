"""
Module that tests cs32/a1s1/count32.py
...
"""
THINGS TO FIX:
1. This code is just a copy of testread32.py. It needs to be
   completely redone for testing count32.py.
2. I don't like the full pathname. Can I avoid that?
"""

# Test-specific paths and filenames
testme = "/Users/profsmith/cs32/a1s1/count32.py"
